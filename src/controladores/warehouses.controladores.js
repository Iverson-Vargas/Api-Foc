...
export class WarehouseController {
  ...
  getOne = async (req, res) => {
    ...
    const { message, status, data } = await WarehouseServices.getById(
      Number(id)
    );
  ...
  created = async (req, res) => {
    ...
    const { message, status, data } = await WarehouseServices.create(
      warehouseData
    );
  ...
  updated = async (req, res) => {
    ...
    const { message, status, data } = await WarehouseServices.update(
      Number(id),
      warehouseData
    );
