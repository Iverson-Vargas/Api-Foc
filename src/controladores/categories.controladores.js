...
export class CategoryController {
  ...
  getOne = async (req, res) => {
    ...
    const { message, status, data } = await CategoryServices.getById(
      Number(id)
    );
  ...
  created = async (req, res) => {
    ...
    const { message, status, data } = await CategoryServices.create(
      categoryData
    );
  ...
  updated = async (req, res) => {
    ...
    const { message, status, data } = await CategoryServices.update(
      Number(id),
      categoryData
    );
